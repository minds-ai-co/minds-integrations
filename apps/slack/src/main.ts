...
const {app, worker} = createSlackApp({publicUrl, signingSecret: required('SLACK_SIGNING_SECRET'),
  clientId: required('SLACK_CLIENT_ID'), clientSecret: required('SLACK_CLIENT_SECRET'), stateSecret: required('SLACK_STATE_SECRET'),
